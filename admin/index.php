...
$pending_percentage = ($total_leave > 0) ? ($pending_leave / $total_leave) * 100 : 0;
$approved_percentage = ($total_leave > 0) ? ($approved_leave / $total_leave) * 100 : 0;
$recalled_percentage = ($total_leave > 0) ? ($recalled_leave / $total_leave) * 100 : 0;
$rejected_percentage = ($total_leave > 0) ? ($rejected_leave / $total_leave) * 100 : 0;
?>
